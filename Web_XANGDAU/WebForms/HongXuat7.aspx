<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Scada.Master" AutoEventWireup="true" CodeBehind="HongXuat7.aspx.cs" Inherits="Web_XANGDAU.WebForms.HongXuat7" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Timer ID="Timer_Hong7" Interval="1000" runat="server" OnTick="Timer_Hong7_Tick"></asp:Timer>
            <div class="tank_title">
                        <i class="bi bi-droplet-half" style="background:#41f1b6;"></i>
                        <span class="title_Tank">Họng 7 - E5 Tank 1</span>
                    </div>
                    <div class="tank" id="E5">
                        ...
                        <div class="box progress" style="height: 30px;background: #11101d;" id="pro51">
                            <asp:Panel ID="pn_MucPerE100" class="progress-bar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:60%;" runat="server">
                                 <asp:Label ID="lbl_MucPerE100" runat="server" Text="---" ForeColor="White"></asp:Label>
                             </asp:Panel>
                        </div>
                        <div class="box progress" style="height: 30px;background: #11101d;" id="pro52">
                            <asp:Panel ID="pn_MucPerRON92" class="progress-bar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:60%;" runat="server">
                                 <asp:Label ID="lbl_MucPerRON92" runat="server" Text="---" ForeColor="White"></asp:Label>
                             </asp:Panel>
                        </div>
                        <div class="box output">
                            <asp:TextBox ID="txt_VanXuatE100" type="text" min="0" max="100" class="form-control-sm textbox VanXuatE100" runat="server" ReadOnly="True" ToolTip="Độ mở van xuất E100"></asp:TextBox>
                            <asp:TextBox ID="txt_VanXuatRON92" type="text" min="0" max="100" class="form-control-sm textbox VanXuatRON92" runat="server" ReadOnly="True" ToolTip="Độ mở van xuất RON92"></asp:TextBox>
                            <asp:TextBox ID="txt_VanXuatE5" type="text" min="0" max="100" class="form-control-sm textbox VanXuatE5" runat="server" ReadOnly="True" ToolTip="Độ mở van xuất E5"></asp:TextBox>
                            <asp:TextBox ID="txt_LuuLuongXuatE100" type="text" min="0" max="100" class="form-control-sm textbox LuuLuongXuatE100" runat="server" ReadOnly="True" ToolTip="Lưu lượng xuất E100"></asp:TextBox>
                            <asp:TextBox ID="txt_LuuLuongXuatRON92" type="text" min="0" max="100" class="form-control-sm textbox LuuLuongXuatRON92" runat="server" ReadOnly="True" ToolTip="Lưu lượng xuất RON92"></asp:TextBox>
                            <asp:TextBox ID="txt_MucE100" type="text" min="0" max="100" class="form-control-sm textbox MucE100" runat="server" ReadOnly="True" ToolTip="Mức E100"></asp:TextBox>
                            <asp:TextBox ID="txt_MucRON92" type="text" min="0" max="100" class="form-control-sm textbox MucRON92" runat="server" ReadOnly="True" ToolTip="Mức RON92"></asp:TextBox>
                            <asp:TextBox ID="txt_NhietDoE100" type="text" min="0" max="100" class="form-control-sm textbox NhietDoE100" runat="server" ReadOnly="True" ToolTip="Nhiệt độ E100"></asp:TextBox>
                            <asp:TextBox ID="txt_NhietDoRON92" type="text" min="0" max="100" class="form-control-sm textbox NhietDoRON92" runat="server" ReadOnly="True" ToolTip="Nhiệt độ RON92"></asp:TextBox>
                        </div>
                        ...
                        <div class="box DonXuat">
                            <div>
                                ...
                                <asp:TextBox ID="txt_MaDonXuat" type="text" class="form-control-sm text-center txt_MaDon" runat="server" ReadOnly="True"></asp:TextBox>
                            </div>
                            <div>
