<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Scada.Master" AutoEventWireup="true" CodeBehind="HongXuat1.aspx.cs" Inherits="Web_XANGDAU.WebForms.HongXuat1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Timer ID="Timer_Hong1" runat="server" Interval="1000" OnTick="Timer_Hong1_Tick"></asp:Timer>
...
<%--                     <div class="progress-bar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:60%;">60%</div>--%>
                 ...
                 <div class="box output">
                     <asp:TextBox ID="txt_VanXuat" type="text" class="form-control-sm textbox VanXuat" runat="server" ReadOnly="True" ToolTip="Độ mở van xuất"></asp:TextBox>
                     <asp:TextBox ID="txt_LuuLuongXuat" type="text" class="form-control-sm textbox LuuLuongXuat" runat="server" ReadOnly="True" ToolTip="Lưu lượng xuất"></asp:TextBox>
                     <asp:TextBox ID="txt_Muc" type="text" class="form-control-sm textbox Muc" runat="server" ReadOnly="True" ToolTip="Mức dầu" ForeColor="Red"></asp:TextBox>
                     <asp:TextBox ID="txt_NhietDo" type="text" class="form-control-sm textbox NhietDo" runat="server" ReadOnly="True" ToolTip="Nhiệt độ bể dầu" ForeColor="Red"></asp:TextBox>
                 </div>
