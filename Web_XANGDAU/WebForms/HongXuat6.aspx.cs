...
{
    public partial class HongXuat6 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PLC_Command.RON95Tank2.LoadTank();
            ...
            if (PLC_Command.plc.Open() == ErrorCode.NoError)
            {
                ...
                PLC_Command.RON95Tank2.ReadData();
            }
        }

        protected void Timer_Hong6_Tick(object sender, EventArgs e)
        {
            txt_Muc.Text = PLC_Command.RON95Tank2.Level + PLC_Command.RON95Tank2.unitLevel;
            txt_NhietDo.Text = PLC_Command.RON95Tank2.Temp + PLC_Command.RON95Tank2.unitTemp;
            txt_VanXuat.Text = PLC_Command.RON95Tank2.throat1.Ctrlvalue.ToString() + PLC_Command.RON95Tank2.unitOpenValve;
            txt_LuuLuongXuat.Text = PLC_Command.RON95Tank2.throat1.Flow.ToString() + PLC_Command.RON95Tank2.unitFlow;
            txt_TheTichDaXuat.Text = PLC_Command.RON95Tank2.throat1.Vout.ToString();

            pn_MucPer.Attributes["style"] = "width:" + PLC_Command.RON95Tank2.LevelPer + "%";
            lbl_MucPer.Text = PLC_Command.RON95Tank2.LevelPer.ToString() + "%";
        ...
        private void StatusSymbol()
        {
            //Trạng thái van xuất
            //Khi van đóng
            if (PLC_Command.RON95Tank2.throat1.Ctrlvalue == 0)
            {
                SVanXuat_1.Visible = false;
                SVanXuat_2.Visible = false;
            }
            //Khi van mở
            else if (PLC_Command.RON95Tank2.throat1.Ctrlvalue > 0 && PLC_Command.RON95Tank2.throat1.Ctrlvalue <= 100)
            {
            ...
            //Trạng thái bơm xuất
            //Khi bơm chạy
            if (PLC_Command.RON95Tank2.throat1.Running == 1)
            {
            ...
            //Trên mức HH
            if (PLC_Command.RON95Tank2.Level >= PLC_Command.RON95Tank2.LevelVeryHigh)
            {
            ...
            //Trên mức H
            else if (PLC_Command.RON95Tank2.Level >= PLC_Command.RON95Tank2.LevelHigh)
            {
            ...
            //Trên mức L
            else if (PLC_Command.RON95Tank2.Level > PLC_Command.RON95Tank2.LevelLow)
            {
                SMucHH_2.Visible = false;
            ...
            //Trên mức LL
            else if (PLC_Command.RON95Tank2.Level > PLC_Command.RON95Tank2.LevelVeryLow)
            {
                SMucHH_2.Visible = false;
                SMucH_2.Visible = false;
            ...
            //Trên mức HH
            if (PLC_Command.RON95Tank2.Temp >= PLC_Command.RON95Tank2.TempVeryHigh)
            {
                lbl_NhietDo.Text = "Quá cao";
                lbl_NhietDo.ForeColor = System.Drawing.Color.Red;
            }
            //Trên mức H
            else if (PLC_Command.RON95Tank2.Temp >= PLC_Command.RON95Tank2.TempHigh)
            {
                lbl_NhietDo.Text = "Cao";
                lbl_NhietDo.ForeColor = System.Drawing.Color.Red;
            }
            //Trên mức L
            else if (PLC_Command.RON95Tank2.Temp > PLC_Command.RON95Tank2.TempLow)
            {
                lbl_NhietDo.Text = "Bình thường";
                lbl_NhietDo.ForeColor = System.Drawing.Color.Black;
            }
            //Trên mức LL
            else if (PLC_Command.RON95Tank2.Temp > PLC_Command.RON95Tank2.TempVeryLow)
            {
